            ...
            <div class="col-md-12 col-lg-12  padding_left_right_null">
                <div class="card ">
                    <div class="card-header text-white card-content-title p-1">
                        <div class="row ">
                            <div class="col-md-6 col-10 text-white m-auto ">Edit Vehicle Details</div>  
                    ...
                    <div class="card-body contents-body">
                        ...
                        <form role="form" id="updateLeaseVehicle" action="<?php echo base_url() ?>updateLeaseVehicle" method="post"
                            role="form">
                            <div class="row form-contents">
                                <div class="col-md-4 col-12">
                                    <div class="form-group">
                                        <label for="vehicle_number">Vehicle Number</label>
                                        <input type="text" class="form-control required" id="vehicle_number" value="<?php echo $leaseVehicleInfo->vehicle_number; ?>" 
                                            name="vehicle_number" placeholder="Vehicle Number" autocomplete="off">
                                            <input type="hidden" value="<?php echo $leaseVehicleInfo->row_id; ?>" name="row_id" id="row_id"/>
                                    </div>
                                </div>
                                <div class="col-md-4 col-12">
                                    <div class="form-group">
                                        <label for="transporter_rowid">Transporter name</label>
                                        <select required name="transporter_rowid" id="transporter_rowid"
                                            ...
                                            <option value="<?php echo $leaseVehicleInfo->transporter_rowid; ?>">Selected:
                                                <?php echo $leaseVehicleInfo->transporter_name; ?></option>
                                ...
                                <div class="col-md-4 col-12">
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control email " id="email" name="email"  value="<?php echo $leaseVehicleInfo->email; ?>"
                                ...
                                <div class="col-md-4 col-12">
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control required" id="contact_number_one"  value="<?php echo $leaseVehicleInfo->contact_number_one; ?>"
                                ...
                                <div class="col-md-4 col-12">
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control " id="contact_number_two"  value="<?php echo $leaseVehicleInfo->contact_number_two; ?>"
                                ...
                                <div class="col-md-4  col-12">
                                    <div class="form-group">
                                        ...
                                        <select class="form-control " id="vehicle_condition" name="vehicle_condition">
                                            <option value="<?php echo $leaseVehicleInfo->vehicle_condition; ?>">Selected: <?php echo  $leaseVehicleInfo->vehicle_condition; ?></option>
                                ...
                                <div class="col-md-4 col-12">
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control " id="rc_number"value="<?php echo $leaseVehicleInfo->rc_number; ?>"
                                ...
                                <div class="col-md-4 col-12">
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control " id="pan_number" value="<?php echo $leaseVehicleInfo->pan_number; ?>"
