                        ...
                        <div class="row">
                            <div class="col-md-8 col-12">
                                <span class="page-title ">
                                    <i class="fa fa-money mobile-title"></i> Cash Book Management
                                </span>
                            </div>
            ...
            <div class="card card-small mb-4">
                <div class="card-body p-1 pb-3 text-center table-responsive">
                    <table class="table mb-0 form-table-padding bordeless">
                        <tr class="bg-deafult">
                            <form action="<?php echo base_url() ?>cashBookListing" method="POST" id="byFilterMethod">
