            ...
            <div class="col padding_left_right_null">
                <div class="card card-small  p-0 ">
                    <div class="card-body p-1 card-content-title  ">
                        <div class="row ">
                            <div class="col-lg-6 text-white">Detailed Member View</div>
                ...
                <ul class="nav nav-tabs" id="myTab" role="tablist">
                    <li class="nav-item">
                        <a class="nav-link active" id="personal-tab" data-toggle="tab" href="#personal" role="tab"
                            aria-controls="personal" aria-selected="false">Member Info</a>
                    </li>
                    <!-- <li class="nav-item">
                        ...
                        <div class="card card-small c-border mb-4">
                            <table class="table table-padding">
                                ...
                                name="userfile" alt="Profile Image Not Uploaded">
                                    ...
                                    <tr>
                                        <th width="230">Member Name<span class="float-right">:</span></th>
                                    ...
                                    <tr>
                                        ...
                                        <td><?php echo $committeeInfo->contact_number_one; ?></td>
                                    </tr>
                                    <tr>
                                        <th>Contact Number Two<span class="float-right">:</span></th>
                                        <td><?php echo $committeeInfo->contact_number_two; ?></td>
                                    </tr>
                                    <tr>
                                        <th>Address<span class="float-right">:</span></th>
                                        <td><?php echo $committeeInfo->committee_address; ?></td>
                                    </tr>
                                    <tr>
                                        <th>Role<span class="float-right">:</span></th>
                                        <td><?php echo $committeeInfo->role; ?></td>
                                    </tr>
                                    <tr>
                                        <th>Year<span class="float-right">:</span></th>
                                        <td><?php echo $committeeInfo->year; ?></td>
                                    </tr>
                                    <!-- <tr>
                    ...
                    <div class="tab-pane fade" id="bill" role="tabpanel" aria-labelledby="bill-tab">
                        <div class="card-body p-1  text-center table-responsive">
                            <table id="bill-list" style="width:100%"
                                ...
                                <tbody>
                                    <?php //foreach($committeeBillInfo as $bill){  ?>
                                    <tr>
