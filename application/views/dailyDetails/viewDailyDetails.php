            ...
            <div class="col padding_left_right_null">
                <div class="card card-small  p-0 ">
                    <div class="card-body p-1 card-content-title  ">
                        <div class="row ">
                            <div class="col-lg-6 text-white">Detailed Daily Pooja View</div>
                ...
                <ul class="nav nav-tabs" id="myTab" role="tablist">
                    <li class="nav-item">
                        <a class="nav-link active" id="personal-tab" data-toggle="tab" href="#personal" role="tab"
                            aria-controls="personal" aria-selected="false">Devotee Info</a>
                    </li>
                    <!-- <li class="nav-item">
                            ...
                            <table class="table table-padding">
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td><?php  if($dpInfo->date=='1970-01-01'){echo $dpInfo->date='';} else { echo date('d-m-Y',strtotime($dpInfo->date));} ?></td>
                                    </tr>
                                    <tr>
