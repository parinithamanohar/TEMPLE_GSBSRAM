            ...
            <div class="col-md-12 col-lg-12  padding_left_right_null">
                <div class="card ">
                    <div class="card-header text-white card-content-title p-1">
                        <div class="row ">
                            <div class="col-md-6 col-10 text-white m-auto ">Edit Transporter Details</div>  
                    ...
                    <div class="card-body contents-body">
                        ...
                        <form role="form" id="updateTransporter" action="<?php echo base_url() ?>updateTransporter" method="post"
                            role="form">
                            <div class="row form-contents">
                                <div class="col-md-4 col-12">
                                    <div class="form-group">
                                        <label for="transporter_name">Transporter Name</label>
                                        <input type="text" class="form-control " id="transporter_name"  value="<?php echo $transporterInfo->transporter_name; ?>"
                                            name="transporter_name" placeholder="Enter Transporter Name"
                                            autocomplete="off">
                                            <input type="hidden" value="<?php echo $transporterInfo->row_id; ?>" name="row_id" id="row_id"/>
                                    </div>
                                </div>
                                <div class="col-md-4 col-12">
                                    <div class="form-group">
                                        <label for="email">Email address (Optional) </label>
                                        <input type="text" class="form-control email " id="email" name="email"  value="<?php echo $transporterInfo->email; ?>"
                                ...
                                <div class="col-md-4 col-12">
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control " id="contact_number"  value="<?php echo $transporterInfo->contact_number; ?>"
                                            name="contact_number" placeholder="Enter Contact Number One"
                                ...
                                <div class="col-md-4 col-12">
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control required" id="transporter_account_number" value="<?php echo $transporterInfo->transporter_account_number; ?>"
                                ...
                                <div class="col-md-8 col-12">
                                    <div class="form-group">
                                        ...
                                        <textarea class="form-control " placeholder="Enter Address"
                                            ...
                                            autocomplete="off"><?php echo $transporterInfo->transporter_address; ?></textarea>
                                    </div>
                                </div>
                                ...
                                <div class="col-md-12 col-12">
                                    <div class="form-group">
                                        ...
                                        <textarea class="form-control " placeholder="Enter Comments"
                                            ...
                                            autocomplete="off"><?php echo $transporterInfo->comments; ?></textarea>
                                    </div>
                                </div>
                            </div>
