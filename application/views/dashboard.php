    ...
    <div class="row padding_left_right_null">
        ...
        <div class="col-lg-3 col-6 column_padding_card ">
            <div class="card card-small dash-card " style="background: #6bd66b;">
                <div class="card-body ">
                    <span class="stats-small__label text-uppercase text-white text-center">committee member  <?php echo $totalCommittee; ?></span>
        ...
        <div class="col-lg-3 col-6 column_padding_card ">
            <div class="card card-small dash-card " style="background: #e6a328">
                <div class="card-body ">
                    <span class="stats-small__label text-uppercase text-white text-center">Devotee &emsp; <?php echo $totalDevotees; ?></span>
                    <h6 class="stats-small__value count text-white"></h6>
                    <div class="icon float-right">
                        <i class="fas fa-users dash-icons"></i>
                    </div>
        ...
        <div class="col-lg-3 col-6 column_padding_card ">
            <div class="card card-small dash-card " style="background: #119a74">
                <div class="card-body ">
                    <span class="stats-small__label text-uppercase text-white text-center">Bank(A/C) &emsp; <?php echo $totalBank; ?></span>
                    <h6 class="stats-small__value count text-white"></h6>
                    <div class="icon float-right">
        ...
        <div class="col-lg-3 col-6  column_padding_card">
            <div class="card card-small dash-card" style="background: #7d7dcc;">
                <div class="card-body ">
                    <span class="stats-small__label text-uppercase text-white text-center">Staff &emsp; <?php echo $totalEmployee; ?></span>
                    <h6 class="stats-small__value count text-white"></h6>
                    <div class="icon float-right">
        ...
        <div class="col-lg-3 col-6  column_padding_card">
            <div class="card card-small dash-card" style="background: #FBBF77;">
                <div class="card-body ">
                    <span class="stats-small__label text-uppercase text-white text-center">Asset &emsp; <?php echo $totalAsset; ?></span>
                    <h6 class="stats-small__value count text-white"></h6>
                    <div class="icon float-right">
        ...
        <div class="col-lg-3 col-6  column_padding_card">
            <div class="card card-small dash-card" style="background: #00CED1;">
                <div class="card-body ">
                    <span class="stats-small__label text-uppercase text-white text-center">Party &emsp; <?php echo $totalParty; ?></span>
                    <h6 class="stats-small__value count text-white"></h6>
                    <div class="icon float-right">
                        <i class="fa fa-users  dash-icons"></i>
                    </div>
    ...
    <div class="col-lg-6 col-6  column_padding_card">
      <div class="card card-small" style="background: #009999;">
        <div class="card-header border-bottom card_head_dashboard" style="background: #009999;">
          ...
          <h6 class="mb-0 text-white text-bold">Today's Panchanga <a class="btn text-white mobile-btn pull-right" style="background: #009999;" href="" data-toggle="modal"
            ...
            <div class="modal-dialog modal-lg ">
                <div class="modal-content">
                    ...
                    <div class="modal-body m-2">
                        ...
                        <form role="form" id="" action="<?php echo base_url() ?>addDetails" method="post"
