                        ...
                        <div class="row ">
                            <div class="col-lg-6 col-sm-8 col-8">
                                <span class="page-title">
                                    <i class="fa fa-bank"></i> Bank Management
                                </span>
                            </div>
                    ...
                    <div class="modal-dialog modal-lg ">
                        <div class="modal-content">
                            ...
                            <div class="modal-body">
                                ...
                                <form role="form" id="addBank" action="<?php echo base_url() ?>addBank" method="post"
                                    role="form">
                                        ...
                                        <div class="col-lg-6 col-12">
                                            <div class="form-group">
                                                ...
                                                <input type="text" class="form-control " id="bank_account_number" 
                                                    name="bank_account_number" placeholder="Enter Account Number"
                                        ...
                                        <div class="col-lg-6 col-12">
                                            <div class="form-group">
                                                ...
                                                <input type="text" class="form-control " id="IFSC_code" name="IFSC_code"
                                                    placeholder="Enter IFSC Code" autocomplete="off" required>
                                            </div>
                                        </div>
                                        <div class="col-lg-6 col-12">
                                            <div class="form-group">
                                                <label for="bank_contact">Contact Number </label>
                                                <input type="text" class="form-control " id="bank_contact"
                                                    name="bank_contact" placeholder="Enter Contact Number "
...
jQuery(document).ready(function() {
    ...
    var table =  $('#bank-list').DataTable({
        ...
        "ajax": {
            url: '<?php echo base_url(); ?>/getBankDetails ',
            type: 'POST',
            // dataType: 'json',
        },
    });
